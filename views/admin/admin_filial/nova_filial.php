...
<head>
    ...
    <meta name="description" content="Cadastro de Nova Filial - CHAMATI">
    <title>Nova Filial - CHAMATI</title>
...
<body class="bg-light">
        ...
        <div class="container">
            <div class="chamado-form-container">
                <h2 class="text-center mb-4 fs-4 text-primary">
                    <i class="bi bi-building me-2"></i>Cadastrar Nova Filial
                </h2>
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-end">
                            <a href="gerenciar_filial.php" class="btn btn-secondary">
                                <i class="bi bi-arrow-left"></i> Voltar
                            </a>
                        </div>
                    </div>
                    <div class="card-body">
                        <form id="formNovaFilial" method="POST" action="/app_chamati/controller/filial/controller_nova_filial.php" class="needs-validation" novalidate>
                            <div class="form-group mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="nome_filial" id="nome_filial" 
                                           class="form-control" required minlength="3" maxlength="100"
                                           pattern="[A-Za-zÀ-ÿ0-9\s\-]+"
                                           placeholder="Digite o nome da filial">
                                    <div class="invalid-feedback">
                                        Por favor, insira um nome válido para a filial (mínimo 3 caracteres).
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="invalid-feedback">
                                        Por favor, insira um endereço válido (mínimo 5 caracteres).
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const form = document.querySelector('#formNovaFilial');
            ...
            const nomeFilialInput = document.querySelector('#nome_filial');
            nomeFilialInput.addEventListener('input', function(e) {
